...
Public Class uxMain
    ...
    Private Sub OpenToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles OpenToolStripMenuItem.Click
        ...
        load.Title = "Load Duo Sat (.txt) Files |*.txt |"
        load.Filter = "Duo Sat (.txt) Files|*.txt|All Files|*"
    ...
    Private Sub SaveToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles SaveToolStripMenuItem.Click
        ...
        saveFileDialog.Title = "Save Duo Sat (.txt) Files |*.txt |"
        saveFileDialog.Filter = "Duo Sat Supported File (.txt) Files|*.txt|All Files|*"
    ...
    Private Sub uxAddToList_Click(sender As Object, e As EventArgs) Handles uxAddToList.Click
        If uxContentName.Text = String.Empty Or uxContentURL.Text = String.Empty Then
        ...
        Else
            If uxIPTVList.Text = String.Empty Then
                uxIPTVList.AppendText(uxContentName.Text.ToLower + ":" + uxContentURL.Text)
                ClearList()
                SortLines(sender, e)
            Else
                uxIPTVList.AppendText(vbCrLf & uxContentName.Text.ToLower + ":" + uxContentURL.Text)
                ClearList()
                SortLines(sender, e)
            End If
        End If
    ...
    Private Sub AboutToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles AboutToolStripMenuItem.Click
        MessageBox.Show("Duo Sat IPTV List Manager created by Tryller", "About", MessageBoxButtons.OK, MessageBoxIcon.Information)
    End Sub
End Class
